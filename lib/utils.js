...
module.exports = (sock, msg) => {
  ...
  if (msg.key) {
    ...
    msg.senderPn = sock.decodeJid(msg.key.participantPn || msg.key.senderPn || "");
    msg.senderLid = sock.decodeJid(msg.key.participant || msg.participant || "");
    msg.sender = sock.decodeJid(msg.fromMe ? sock.user.id : (msg.senderPn || msg.senderLid || msg.chat));
    if (msg.isGroup) msg.participant = msg.senderPn || msg.senderLid || '';
  }

  if (msg.message) {
    msg.mtype = e(msg.message);
    msg.prefix = readPrefix();
